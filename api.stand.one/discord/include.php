...
if(!$token)
{
	error_log("Missing DISCORD_BOT_TOKEN environment variable.");
	http_response_code(500);
	die("Discord integration misconfigured.");
}
...
{
	error_log("Missing DISCORD_CLIENT_SECRET environment variable.");
	http_response_code(500);
	die("Discord integration misconfigured.");
}
